...
Ideal gas constant $R_m = 8.314 \frac{\text{kg }\text{m}^2}{\text{s }\text{mol }\text{K}}$\\
...
\begin{itemize}
	\item \textbf{Good}: easy to store like solids, can handle metal additives without sedimentation, in use similar to liquid propellants due to scherverdünnenden Verhalten
...
\begin{itemize}
	\item \textbf{Good}: less/non toxic, reduced enviromental impact, possibly cheaper due to easier handling, in theory higher perfomance than conventional
	\item \textbf{Bad}: little experience -> more research and testing essential
\end{itemize}
